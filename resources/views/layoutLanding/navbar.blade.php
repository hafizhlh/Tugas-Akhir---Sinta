<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
    <a href="index.html" class="navbar-brand d-flex align-items-center">
        <h2 class="m-0 text-primary"><img class="img-fluid me-2" src="{{ asset('landingPage/img/sintalogo.png') }}" alt="" style="width: 140px;"></h2>
    </a>
        ...
        <div class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <div class="row gx-5 p-4">
                        <div class="col-6">
                            <ul class="list-unstyled">
                                <li><a href="/" class="nav-item">Tentang TI</a></li>
                                <hr>
                                <li><a href="#" class="nav-item">Awarding</a></li>
                                <hr>
                                <li><a href="#" class="nav-item">ITSC & IT Agent PKG</a></li>
                                <hr>
                        ...
                        <div class="col-6">
                            <ul class="list-unstyled">
                                <li><a href="#" class="nav-item">Telp ext</a></li>
                                <hr>
                                <li><a href="#" class="nav-item">Daftar aplikasi TI (internal)</a></li>
                                <hr>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-xlarge p-4 shadow-sm">
                    <ul class="list-unstyled">
                        <li><a href="/tentang-TI" class="nav-item">Sejarah TI</a></li>
                        <hr>
                        <li><a href="/tentang-TI#tugas-dan-tanggung-jawab-TI" class="nav-item">Tugas dan Tanggung Jawab Bagian</a></li>
                        <hr>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-xlarge p-4 shadow-sm">
                    <ul class="list-unstyled">
                        <li><a href="#" class="nav-item">Tugas dan Tanggung Jawab ITSC</a></li>
                        <hr>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-xlarge p-4 shadow-sm">
                    <ul class="list-unstyled">
                        <li><a href="/it-agent" class="nav-item">Tugas dan Tanggung Jawab IT Agent</a></li>
                        <hr>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-xlarge p-4 shadow-sm">
                    <ul class="list-unstyled">
                        <li><a href="/security-awareness" class="nav-item">Poster</a></li>
                        <hr>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-xlarge p-4 shadow-sm">
                    <ul class="list-unstyled">
                        <li><a href="#" class="nav-item">Self Diagnoses</a></li>
                        <hr>
            ...
            <a href="/login" class="nav-item nav-link"><img class="img-fluid me-2" src="{{ asset('landingPage/img/sintalogo.png') }}" alt="" style="width: 50px;"></a>
        </div>
</nav>