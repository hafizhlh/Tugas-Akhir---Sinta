...
<!-- export modal begin
<div class="modal" id="exportBulanan" tabindex="-1">
    ...
    $(document).ready(function () {
...

                {
                    ...
                    template: function (row) {
                        ...
                        row.id_barang_masuk + " data-tanggal_barang_masuk=" + row
                            .tanggal_barang_masuk + " data-nama_barang=" + row.nama_barang +
        ...
        $(document).on('click', '.edits', function () {
            $.ajax({
                ...
                url: './barangmasuk/' + $(this).data('id'), // the url where we want to POST
                beforeSend: function () {
                    let form = document.forms.formmenus; // <form name="formmenus"> element
                    form.reset();
                    $(`.form-control`).removeClass('is-invalid');
