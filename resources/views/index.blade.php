    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    <h1 class="display-6 text-success">PORT INFORMATION</h1>
                    <!-- <p class="text-primary fs-5 mb-4">The Most Trusted Cryptocurrency Platform</p> -->
                    <p  class="text-warning">Berdasarkan Keputusan Menteri Perhubungan Nomor: KP 316 Tahun 2011 yang ditetapkan di Jakarta pada tanggal 5 Mei 2011 di Jakarta, Kementerian Perhubungan memberikan persetujuan kepada PT Petrokimia Gresik bekerja sama dengan Penyelenggara Pelabuhan Gresik untuk mengelola terminal untuk kepentingan sendiri di dalam Daerah Lingkungan Kerja dan Daerah Lingkungan Kepentingan Pelabuhan Gresik guna menunjang kegiatan usaha di bidang industri pupuk buatan dan penyediaan tenaga listrik PT Petrokimia Gresik.
                    </p>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-4 col-md-6 text-center wow fadeIn" data-wow-delay="0.1s">
                <img class="img-fluid mb-4" src="{{ asset('landingPage/img/icon-9.png') }}" alt="">
                <h1 class="display-4" data-toggle="counter-up">123456</h1>
                <p class="fs-5 text-primary mb-0">Today Transactions</p>
            </div>
            <div class="col-lg-4 col-md-6 text-center wow fadeIn" data-wow-delay="0.3s">
                <img class="img-fluid mb-4" src="{{ asset('landingPage/img/icon-10.png') }}" alt="">
                <h1 class="display-4" data-toggle="counter-up">123456</h1>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="d-flex align-items-start">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('landingPage/img/icon-7.png') }}" alt="">
                    <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="d-flex align-items-start">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('landingPage/img/icon-6.png') }}" alt="">
                    <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="d-flex align-items-start">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('landingPage/img/icon-4.png') }}" alt="">
                    <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="d-flex align-items-start">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('landingPage/img/icon-3.png') }}" alt="">
                    <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="d-flex align-items-start">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('landingPage/img/icon-8.png') }}" alt="">
                    <div class="ps-4">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('landingPage/img/icon-7.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('landingPage/img/icon-5.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('landingPage/img/icon-8.png') }}" alt="">
...
<div class="container-xxl bg-light py-5 my-5">
    <div class="container py-5">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            ...
            <p class="text-success fs-5 mb-5">TUKS PT. Petrokimia Gresik</p>
        </div>
        <div class="row g-3">
            <div class="col-6 col-md-3 wow fadeIn" data-wow-delay="0.1s">
                <div class="bg-white text-right p-3">
                    <img class="img-fluid mb-4" src="{{ asset('landingPage/img/4.jpg') }}" alt="">
                    <span class="text-success fs-5">DISCHARGING<br></span>
                     <span>   - Kapasitas Jalur NH3: 330 Ton/jam<br>

                        - Kapasitas Jalur H2SO4: 300 Ton/jam<br>
                        
                        - Kapasitas Jalur H3PO4: 400 Ton/jam</span>
                </div>
            </div>
