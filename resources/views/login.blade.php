...
<div class="d-flex flex-column flex-root">
  ...
  <div class="login-aside flex-row-fluid d-flex flex-column"
             style="background-image:url({{url('assets/media/bg/background.png')}});background-repeat: no-repeat;background-repeat: round;">
        ...
        <!--begin::Wrapper-->
            <div class="d-flex flex-column-auto flex-column pt-lg-0 pt-15" >
                ...
                <a href="#" class="login-logo text-right pt-lg-10 pb-5 pr-15">
                    <img src="{{ asset('assets/media/logos/logo-petro.png') }}" class="max-h-50px" alt=""/>
                </a>
            </div>
                    ...
                    <!--begin::Title-->
                        <div class="pb-5 pb-lg-5">
                            ...
                            <img src="{{ asset('assets/media/logos/logo.png') }}"
                                 style=" display: block;margin: 0 auto; width: 280px;" alt=""/>
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" style="background-color:#00ae4d;"
